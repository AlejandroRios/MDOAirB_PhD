...
def objective_function0(x, original_vehicle, computation_mode, route_computation_mode, airports, distances, demands):
    ...
    try:
        ...
        with open('Database/Family/40_to_100/all_dictionaries/'+str(46)+'.pkl', 'rb') as f:
            all_info_acft1 = pickle.load(f)

        with open('Database/Family/101_to_160/all_dictionaries/'+str(19)+'.pkl', 'rb') as f:
            all_info_acft2 = pickle.load(f)

        with open('Database/Family/161_to_220/all_dictionaries/'+str(69)+'.pkl', 'rb') as f:
            all_info_acft3 = pickle.load(f)

        # print(all_info_acft3['vehicle']['aircraft']['passenger_cap""" acity'])
